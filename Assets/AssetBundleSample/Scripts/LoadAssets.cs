...
public class LoadAssets : MonoBehaviour
{
    ...
    {
        //AssetBundleManager.SetSourceAssetBundleURL("http://epsc.wustl.edu/~martinpratt/AssetBundles");
        //return;
    ...
    protected IEnumerator InstantiateGameObjectAsync(string assetBundleName, string assetName)
    {
        ...
        //    AnchorDebugText.text += "\nLocal Euler Angles: " + go.transform.localEulerAngles;
        //    AnchorDebugText.text += "\nEuler Angles: " + go.transform.eulerAngles;
        //    AnchorDebugText.text += "\nWorld Position: " + go.transform.position;
        //}
