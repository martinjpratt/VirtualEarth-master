...
namespace HoloToolkit.Sharing.Tests
{
    ...
    public class RemoteHeadManager : Singleton<RemoteHeadManager>
    {
        ...
        private void Update()
        {
            ...
            Vector3 headPosition = transform.InverseTransformPoint(GazeManager.Instance.HitPosition);  //Update to share gaze position
        ...
        private GameObject CreateRemoteHead()
        {
            ...
            newHeadObj.GetComponent<Renderer>().sharedMaterial.color = UnityEngine.Random.ColorHSV(0f, 1f, 0.5f, 0.8f, 1f, 1f);
            newHeadObj.transform.parent = gameObject.transform;
            newHeadObj.transform.localScale = new Vector3(0.01f, 0.01f, 0.01f);
